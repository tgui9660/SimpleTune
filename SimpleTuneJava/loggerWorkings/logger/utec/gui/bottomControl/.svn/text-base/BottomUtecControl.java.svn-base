 ...
 */
package logger.utec.gui.bottomControl;
...
import logger.utec.gui.JutecGUI;
...
public class BottomUtecControl extends JPanel implements ActionListener,
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd.equals("OPEN PORT")) {
			logger.info("Opening connection to defined port: "
		...
		if (cmd.equals("CLOSE PORT")) {
			logger.info("Closing connection to defined port");
		...
		if (cmd.equals("START CAPTURE")) {
			logger.info("Starting data capture from the UTEC");
		...
		if (cmd.equals("STOP CAPTURE")) {
			logger.info("Stopping data capture from the UTEC");
	...
	public void getCommEvent(double[] doubleDarta) {
		...
		// logger.info("Adding data to the text AREA");
	}
}
