...
import logger.utec.commInterface.UtecSerialListener;
...
public class UtecSerialConnectionManager{
	private static Log logger = LogFactory.getLog(UtecSerialConnectionManager.class);
	...
	public static void init(){
		...
		try {
			...
			logger.info("Error initializing the connection parameters.");
			e.printStackTrace();
		}
	}
	...
	public static void sendCommandToUtec(int charValue) {
		...
		try {
			...
			logger.info("Sending char to the utec:"+charValue);
		} catch (IOException e) {
	...
	public static void openConnection() throws SerialConnectionException {
		logger.info("Opening connection now.");
		...
		try {
			// logger.info("PORT: "+parameters.getPortName());
		...
		open = true;
		logger.info("Port opened with success.");
	}
	...
	public static void closeConnection() {
		...
		logger.info("Closing connection to the currently targeted port");
